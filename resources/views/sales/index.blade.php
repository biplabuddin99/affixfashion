    ...
    <div class="row" id="table-bordered">
        <div class="col-12">
            <div class="card">
                ...
                @endif
                <div>
                    <a class="float-end" href="{{route('sales.create')}}"style="font-size:1.7rem"><i class="bi bi-plus-square-fill"></i></a>
                </div>
                <!-- table bordered -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="white-space-nowrap">
                                    {{-- <a href="{{route('sales.edit',encryptor('encrypt',$s->id))}}">
                                        <i class="bi bi-pencil-square"></i>
                                    </a> --}}
                                    {{--<a href="javascript:void()" onclick="$('#form{{$s->id}}').submit()">
                                        <i class="bi bi-trash"></i>
                                    </a>
                                    <form id="form{{$s->id}}" action="{{route('purchase.destroy',encryptor('encrypt',$pur->id))}}" method="post">
                                        @csrf
                                        @method('delete')
                                    </form>--}}
                                </td>
